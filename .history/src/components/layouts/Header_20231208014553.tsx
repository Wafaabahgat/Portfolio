  ...
  return (
    <>
      <div className="mt-10 ">
        ...
        {showMenu && (
          <div>
            <nav className="fixed py-3 z-11 inset-0 text-center w-[85%] mt-10 bg-bg-menu mx-auto rounded-2xl">
              <ul className="">
                <li
                  onClick={() => {
                    setShowMenu(false);
                  }}
                  className="bg-white text-bg-header rounded-full w-[20px] h-[20px] "
                >
                  <IoMdClose />
                </li>
                {links?.map((e, i) => (
