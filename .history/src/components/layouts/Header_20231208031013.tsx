  ...
  return (
    <>
      <div className="mt-5">
        ...
        {showMenu && (
          <div className="fixed py-3 z-11 inset-0 max-w-[85%] max-h-[48%] mt-10 bg-bg-menu mx-auto rounded-2xl">
            ...
            <ul className="">
              {links?.map((e, i) => (
                <li
                  key={i}
                  className="capitalize text-black text-[20px] text-start px-10 py-3 border-li border-b border-bg-border hover:text-main-light hover:text-[25px]"
                >
                  <a href={e?.href}>{e?.name}</a>
                </li>
              ))}
