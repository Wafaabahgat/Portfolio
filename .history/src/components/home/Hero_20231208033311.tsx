    ...
    <>
      <div className="mt-10">
        <div>
          ...
          <div className="flex gap-4  w-[40px] h-[40px]">
            <FaGithub className="text-3xl rounded-full  border-2 border-border-menu " />
            <FaLinkedinIn className="text-3xl rounded-full border-2 border-border-menu " />
            <FaFacebookF className="text-3xl rounded-full border-2 border-border-menu " />
            <FiTwitter className="text-3xl rounded-full border-2 border-border-menu " />
          </div>
        </div>
      </div>
    </>
