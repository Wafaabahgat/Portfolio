...
const Hero: FC<HeroProps> = () => {
  return (
    <>
      <div className="mt-20 grid md:grid-cols-2 gri">
        <div className=" ml-20">
          ...
          <h1 className="text-main-title font-semibold md:text-5xl text-4xl capitalize">
            frontend react.js
          </h1>
          <p className=" text-sub-title md:text-[16px] text-[13px] bg-slate-700 my-6">
        ...
        <div className="m-auto">animation</div>
      </div>
    </>
  );
};
