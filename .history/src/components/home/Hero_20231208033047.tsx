      ...
      <div className="mt-10">
        <div>
          ...
          <div className="flex gap-4 ">
            <FaGithub className="text-2xl rounded-full p-3 border-2 border-border-menu "/>
            <FaLinkedin className="text-2xl rounded-full border-2 border-border-menu "/>
            <FaFacebookF className="text-2xl rounded-full border-2 border-border-menu "/>
            <FiTwitter className="text-2xl rounded-full border-2 border-border-menu "/>
          </div>
        </div>
      </div>
    </>
