    ...
    <>
      <div className="mt-10">
        <div>
          ...
          <h1 className="text-main-title font-semibold text-5xl mb-5 capitalize">
            frontend react.js
          </h1>
          <p className=" text-sub-title text-md mb-5">
          ...
          <div className="flex gap-4">
            ...
            <FaLinkedinIn className="text-2xl hover:text-3xl" />
            <FaFacebookF className="text-2xl hover:text-3xl" />
